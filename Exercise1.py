...
class Model:
    def __init__(self, run_number): # Prepara el enviroment, el contador de pacientes, los recursos y un data frame para almacenar los resultados (optativo)
        ...
        # Crea un recurso que representa a las enfermeras. El número de enfermeras es un parámetro global que viene indicado arriba y que
        # asignaremos a la capacidad. Este recurso se creará dentro del ambiente en el que vivimos.
    ...
    def attend_clinic(self, p):
        ...
        # Pide el recurso de la primera actividad (enfermera) y haz todo el proceso de después empleando ese recurso haciendo 
        ...
        with self.nurse.request() as req:
            ...
            consult_time = random.expovariate(1 / g.mean_n_consult_time)
...
class Trial:
    ...
    def run_trial(self):
        ...
        for run in range(g.number_of_runs):
            ...
            self.df_trial_results.loc[run] = [model.mean_q_time_nurse]

...
'''
En esta versión, hemos añadido una nueva actividad antes de la consulta con la enfermera: la recepción.
La recepción es gestionada por un recurso de SimPy llamado "receptionist", que tiene una capacidad definida por el
 número de recepcionistas disponibles. Hasta que un paciente no pasa por la recepción, no puede acceder a la consulta con la enfermera.
'''
...
class Model:
    def __init__(self, run_number): # Prepara el enviroment, el contador de pacientes, los recursos y un data frame para almacenar los resultados (optativo)
        ...
        # Crea un recurso que representa a las enfermeras y a los recepcionistas.
        self.receptionist = simpy.Resource(self.env, capacity=g.number_of_receptionists) ##NEW
        ...
        self.results_df['Q Time Receptionist'] = [0.0] ##NEW
        self.results_df['Time with Receptionist'] = [0.0] ##NEW
    ...
    def attend_clinic(self, p):
        ## NEW: Primera actividad: Recepción
    ...
    def calculate_run_results(self): 
        ...
        self.mean_q_time_recep = self.results_df['Q Time Receptionist'].mean() ##NEW
...
class Trial:
    ...
    def __init__(self):
        ...
        self.df_trial_results['Mean Q Time Receptionist'] = [0.0] ##NEW
    ...
    def run_trial(self):
        ...
        for run in range(g.number_of_runs):
            ...
            ## NEW (Guarda los resultados del tiempo medio de la recepcionista)
